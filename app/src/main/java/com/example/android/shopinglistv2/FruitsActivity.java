...
public class FruitsActivity extends AppCompatActivity {
    ...
    private void displayLemon(int i) {
        TextView quantityLemonTextView = (TextView) findViewById9R.id.lemonNumber);
        quantityLemonTextView.setText("" + i);}
    private void displayOrange(int i) {
        TextView quantityOrangeTextView = (TextView) findViewById(R.id.orangeleNumber);
    ...
    private void displayWatermelon(int i) {
        TextView quantityWatermelonTextView = (TextView) findViewById(R.id.watemelonNumber);
